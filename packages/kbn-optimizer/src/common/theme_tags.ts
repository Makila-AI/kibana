...
export type ThemeTag = 'v7light' | 'v7dark' | 'v8light' | 'v8dark' | 'v7makilalight';
export const DEFAULT_THEMES = tags('v8light', 'v8dark', 'v7makilalight');
export const ALL_THEMES = tags('v7light', 'v7dark', 'v8light', 'v8dark', 'v7makilalight');
